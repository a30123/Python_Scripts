...
output_folder_filename="C://Users//A30123.ITRI//Documents//Python Scripts//New_for_event_mining//Try_20150504_feature_mean_relative_error//mean_relative_error_flat_region.csv"
#########################################################################################################
#######################################   MAIN PROGRAM        ###########################################
#########################################################################################################
tstart = time.time()
...
for i in range(len(files_in_folder)):
    ...
    if (sum(flat_region_occurrence)!=0):
        ...
        relative_error_to_consider=relative_error_float[flat_region_occurrence]
