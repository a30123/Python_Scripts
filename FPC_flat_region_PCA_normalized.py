...
figure_folder="C://Users//A30123.ITRI//Documents//Python Scripts//FPC//Try_20150904_PCA_normalize//output"
...
#    trip_points[i]=np.array(temp_trip)
    ...
    subset_All_temp3=(subset_All_temp3-subset_All_temp3.mean())/subset_All_temp3.std()    
