...
for i in range(len(files_in_folder)):
    ...
    error_values=np.array(current_values-setpoint_values,dtype='float16')
    unreal_error=abs(error_values)
    ...
    plot_and_save_list_values(relative_error,path_to_save_png,unreal_error_filename)
