...
path_to_save_csv="C://Users//A30123.ITRI//Documents//Python Scripts//New_for_event_mining//Try_20150521_thirty_time_unit_window//unreal_relative_error_thirty_time_unit_window.csv"#----------------------------"folder to save output to"
path_to_save_csv2="C://Users//A30123.ITRI//Documents//Python Scripts//New_for_event_mining//Try_20150521_thirty_time_unit_window//unreal_relative_error_thirty_time_unit_window_number.csv"#----------------------------"folder to save output to"
path_to_save_csv3="C://Users//A30123.ITRI//Documents//Python Scripts//New_for_event_mining//Try_20150521_thirty_time_unit_window//unreal_relative_error_thirty_time_unit_window_max.csv"#----------------------------"folder to save output to"
...
for i in range(len(files_in_folder)):
    ...
    if run_length<window_size:
        ...
        sum_list=(filtered_values[0:(run_length-window_size+1)]>=accuracy)+0
...
write_array_to_csv(path_to_save_csv3,max_percentage_list)
